...
red:        pokered.md25s
blue:       pokeblue.md25s
blue_debug: pokeblue_debug.md25s
...
%.patch: vc/%.constants.sym %_vc.md25s %.md25s vc/%.patch.template
